...
class DuckduckgoSkill(CommonQuerySkill):
    ...
    start_words = ['quem', 'qual', 'quais', 'o que', 'quando']
    # Note the spaces
    question_verbs = [' é', ' são', ' did', ' was', ' were']
    articles = ['um', 'uma', 'o', 'as', 'os', 'any']
    question_words = ['é', 'e', 'um', 'uma', 'do', 'de', 'da', 'das', 'dos', 'se', 'o', 'as', 'os'
                   'porque', 'desde', 'para', 'por',
                   'quando', 'entre', 'quem', 'foi', 'foram', 'em']
    is_verb = ' is '
    in_word = 'in '
